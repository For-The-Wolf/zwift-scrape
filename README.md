...
3. To run on linux `geckodriver-linux` needs to be given permission to be run as an executable: this can be done with `sudo chmod +x ./drivers/geckdriver-linux`
